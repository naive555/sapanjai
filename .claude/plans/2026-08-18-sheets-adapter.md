...
> **Status: 🟡 in progress (planned 2026-08-18).** 5 / 12 steps complete — the riskiest unknown (MCP handshake + RBAC end to end) is retired, the rate limiter landed ahead of any real Google adapter, and the `google_sheets` connector type + allowlist + health checker are live.
